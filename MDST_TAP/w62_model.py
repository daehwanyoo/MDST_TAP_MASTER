...
y = (us_accidents['Severity'] >= 3).astype(int)  # Binary: 0 = mild, 1 = serious
# Convert to PyTorch tensors
X_tensor = torch.tensor(X, dtype=torch.float32)
y_tensor = torch.tensor(y, dtype=torch.long)  # Shift labels from 1-4 to 0-3
...
class AccidentSeverityModel(nn.Module):
    def __init__(self):
        ...
        self.fc3 = nn.Linear(32, 2)  # 4 classes
        self.relu = nn.ReLU()
...
# **Reduce overfitting with higher weight decay**
